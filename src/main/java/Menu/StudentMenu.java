...
public class StudentMenu {
    ...
    private void enrollInSection() {
        ...
        int academicYear = Integer.parseInt(scanner.nextLine());
        ...
        if (selectedSection != null) {
            ...
            System.out.println("Enrolled Section successfully " );
        } else {
    ...
    private void viewEnrolledSections() {
        ...
        System.out.println("Total enrolled sections found: " + enrolledSections.size());
        ...
        if (enrolledSections.isEmpty()) {
            ...
            for (Section section : enrolledSections) {
                ...
                System.out.println("Start Date: " + dateFormat.format(section.getStartDate()));
                System.out.println("End Date: " + dateFormat.format(section.getEndDate()));
                System.out.println("Lecturer: " + section.getTaughtBy());
            }
            System.out.println("-------------------------------");
        }
    }
    ...
    private void unrollFromSection() {
        ...
        enrolledSections.forEach(section -> System.out.println(" - Course ID: " + section.getCourse().getCourseId() +
        ...
        if (sectionToRemove != null) {
            ...
            System.out.println("Successfully unrolled from Section ");
        } else {
            System.out.println("No matching section found.");
        }
    }
    ...
    private void updateEnrolledSectionsFile(List<Section> enrolledSections) {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter(filePath))) {
            for (Section section : enrolledSections) {
                // Lưu thông tin mỗi section vào file, bao gồm studentId
                String line = loggedInStudent.getId() + "," + section.getCourse().getCourseId() + "," +
                        section.getCourse().getName() + "," + section.getCourse().getDepartment() + "," +
                        section.getCourse().getLevel() + "," + section.getSemester() + "," +
                        section.getAcademicYear() + "," + new SimpleDateFormat("dd/MM/yyyy").format(section.getStartDate()) + "," +
                        new SimpleDateFormat("dd/MM/yyyy").format(section.getEndDate()) + "," + section.getTaughtBy();
                writer.write(line);
                writer.newLine();
                System.out.println("Updated section: " + line); // Debug line
            }
        } catch (IOException e) {
